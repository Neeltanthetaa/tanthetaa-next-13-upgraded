		...
		<>
			<div className={cx(" p-8 lg:p-24 my-10", content?.backGroundColor)}>
				<div className="max-w-5xl mx-auto text-center">
					<h3 className="font-mono text-3xl font-bold text-white">{content?.title && content?.title}</h3>
					<p className="mt-5 text-[#EAEAEA] text-lg ">{content?.description && content?.description}</p>
				</div>
