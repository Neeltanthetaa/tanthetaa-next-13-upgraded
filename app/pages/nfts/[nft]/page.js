...
export const metadata = {
	title: "Expert NFT development and consulting services from Tan θ Software Studio",
	description:
...
const NFT = async ({ params }) => {
	...
	return (
		<>
			{/* 1st Component Start */}
			<NFTHead path={`nfts/nft-development-services`} content={content?.data?.header} />
			{/* 1st Component End */}
			...
			<TokenDevelopment path={`nfts/nft-development-services`} content={content?.data?.section2?.services} />
			{/* 3rd Component End */}

			{/* 4th Component Start */}
			<NFTDevelopment content={content?.data?.section3} />
			<NFTProcess path={`nfts/nft-development-services`} content={content?.data?.section3?.services} />
			{/* 4th Component End */}
			...
			<NFTFractures path={`nfts/nft-development-services`} content={content?.data?.section5} />
			{/* 6th Component End */}
			...
			<NFTPartners path={`nfts/nft-development-services`} content={content?.data?.section7?.services} />
			{/* 8th Component End */}

			{/* 9th Component Start */}
			<NFTClients path={`nfts/nft-development-services`} content={content?.data?.section8} />
			{/* 9th Component End */}

			{/* 10th Component Start */}
			<NFTDevelopment content={content?.data?.section9} />
			<NFTSpotlighted path={`nfts/nft-development-services`} content={content?.data?.section9?.services} />
			{/* 10th Component End */}
			...
			<NFTService path={`nfts/nft-development-services`} content={content?.data?.section11} />
			{/* 12th Component End */}
			...
			<Blogs path={`nfts/nft-development-services`} content={content?.data?.section13?.services} />
			{/* 14th Component End */}

			{/* 15th Component Start */}
			<PreviousOrNext path={`nfts/nft-development-services`} content={content?.data?.section14?.services} />
			{/* 15th Component End */}
