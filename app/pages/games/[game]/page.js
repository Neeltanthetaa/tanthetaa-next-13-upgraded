...
export const metadata = {
  title:
    "Expert Game development and consulting services from Tan θ Software Studio",
  description:
...
const Game = async ({ params }) => {
  ...
  return (
    <>
      ...
      <OurDevServices
        path={`games/${params.game}`}
        content={content.data.section13}
      />
      {/* In Progress */}
      {/* 3rd Component End */}
      ...
      <div className="my-20">
        <div className="grid w-full lg:grid-cols-2 gap-4 h-min">
          <div className="flex gap-8">
            <div className="flex flex-col">
              <img
                src="/assets/games/android-game-development-services/grassGroup.png"
                alt=""
              />
            </div>
            <div>
              <div>
                <img
                  src="/assets/games/android-game-development-services/groupStar.png"
                  alt=""
                />
                ...
                <div className="">
                  ...
                  <p className="mt-2 text-base text-[#333333]">
                    Juicy Fruits is game where the player manipulates tiles in
                    order to make them disappear according to a matching
                    criterion
                  </p>

                  <div className="my-12 flex gap-4 flex-wrap items-center flex-row">
                    {[1, 2, 3, 4, 5].map((i, el) => (
                  ...
                  <div>
                    <h4 className="mt-3 font-inter text-lg ">
          ...
          <div className="place-content-end grid">
            <img
              src="/assets/games/android-game-development-services/gameProjectGroup.png"
              alt=""
            />
          </div>
        </div>
      ...
      <GameBlogs
        path={`games/${params.game}`}
        content={content.data.section11.services}
      />
      {/* 13th Component End */}
      ...
      <PreviousOrNext
        path={`games/${params.game}`}
        content={content.data.section12.services}
      />
      {/* 14th Component End */}
